...
-- Sets how certain whitespace will display in the editor.
--  See `:help 'list'`
--  and `:help 'listchars'`
vim.opt.list = true
...
require("lazy").setup({
	...
	{ "f-person/git-blame.nvim", opts = { date_format = "%r" } },
	{
		...
		config = function()
			...
			cmp.setup({
				...
				mapping = cmp.mapping.preset.insert({
					...
					--  Generally wont need this, because nvim-cmp will display
